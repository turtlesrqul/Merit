      ...
      <AppShell>
        <section className="space-y-5">
          <Card className="space-y-3 border-sun-200 bg-gradient-to-r from-sun-50 to-white">
            <p className="text-xs font-semibold uppercase tracking-[0.1em] text-ink-600">Guest mode</p>
            <h1 className="text-2xl font-semibold text-ink-950">Discover proof-of-work without signing in</h1>
